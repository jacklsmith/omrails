...
class TrackingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracking" do
    assert_difference('Tracking.count') do
      post trackings_url, params: { tracking: { content: @tracking.content, user_id: @tracking.user_id } }
    end
  ...
  test "should update tracking" do
    patch tracking_url(@tracking), params: { tracking: { content: @tracking.content, user_id: @tracking.user_id } }
